...
import { AuthManager } from '../../src/modules/authManager';
...
describe('AuthManager', () => {
    ...
    describe('addUser', () => {
        it('should add new user with {test, test, test}', (done) => {
            AuthManager.addUser('test', 'test', 'test')
        ...
        it('should throw a rejection with {test, test, undfined}', (done) => {
            AuthManager.addUser('test', 'test', undefined)
                .then(user => {
    ...
    describe('checkPassword', () => {
        it('should return true if password matches', (done) => {
            ...
            AuthManager.checkPassword('test', 'test')
                .catch(err => {
                    done(err);
                })
                .then(result => {
